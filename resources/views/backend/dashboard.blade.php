...
@section('content')
    <div class="page-title">
        <div class="row">
            <div class="col-sm-6">
                <h4 style="font-family: 'Cairo', sans-serif;"> {{trans('backend/dashboard.control Board')}}</h4>
            </div>
            <div class="col-sm-6">
                <ol class="breadcrumb pt-0 pr-0 float-left float-sm-right">
                    <li class="breadcrumb-item"><a href="index.html" class="default-color">{{trans('backend/dashboard.Home')}}</a></li>
                    <li class="breadcrumb-item active">{{trans('backend/main-sidebar.Dashboard')}}</li>
                </ol>
            </div>
        </div>
    </div>
